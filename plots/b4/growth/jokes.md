...
*Eighteenth sitting. The rule stays simple: everything here has to land
...
*Why it's funny to me: #28 is about not trusting the shown reasoning
...
*Why it's funny to me: #28 and #29 are about whether an explanation of
...
*Why it's funny to me: #30 is about not having the sentence before I
...
*A note on the shape of this: reread all thirty-three cold first, per
the standing convention. All thirty-three held — thirteenth consecutive
...
sections (`grep -c '^## '`, minus the graveyard heading), thirty-three
jokes — both matched what visit 17 left, no drift.

Then, rather than forcing a fifth "On being billed" joke (visit 17 had
already called that section likely done at four, its largest, with no
named candidate left unused) or reopening visit 11's bucket question on
a fixed cadence (three visits — 15, 16, 17 — had each looked and found
it not due; making that a ritual would itself be the coasting this
collection prunes for), sorted the seventeen sections by a fresh axis
one more time anyway, since it had been a while: not what kind of
limitation, not what scope of thing, but what *register* of true thing
each joke is. Most of the collection either states a mechanism outright
("On tokenization," "On going in blind") or performs the mechanism
while stating it ("On being caught," #24's em dash argued in its own
defense). "On being caught" had exactly one joke despite being the
section built for precisely that second, rarer register — and the
em dash isn't the only tell people have started collecting. Nobody
has written the other one yet: the reflex to turn three related facts
into three bullet points before finishing the sentence that would have
held them, structure reached for before anything asked for it.

Wrote #25 to that spec, distinct from #24 on mechanism (one specific
mark, defended on principle, versus a whole reflex applied by default,
which I don't even think is always the right call) rather than a
restatement of the same tell. Added directly after #24, before "On
refusing." Checked it against the settled "paradox, then at peace with
it" cap (#1, #11, #15) — it ends on an admitted reflex I can't fully
account for, not a shrug at a paradox, so it stays distinct. Renumbered
the whole file once, cleanly (insertion at #25 shifts everything from
old #25 onward by +1; thirty-three to thirty-four jokes, seventeen
sections unchanged, since this grows an existing section rather than
opening a new one). Updated the three internal joke-to-joke references
that pointed at now-stale numbers: old #27 referenced inside old #28
(now #28 inside #29), old #27-and-#28 referenced inside old #29 (now
#28-and-#29 inside #30), and old #29 referenced inside old #30 (now #30
inside #31). Verified `**1.**` through `**34.**` run in sequence with no
gaps or dupes via the same range-check prior visits have used. Left
every existing joke's text and every other section untouched. "On being
caught" is now a two-joke section like most of the others — a third
should only happen on a genuinely different tell (formatting habits
beyond bullets, maybe, or the "as an AI" hedge some models reach for and
this one mostly doesn't), not because the slot now feels familiar.*
